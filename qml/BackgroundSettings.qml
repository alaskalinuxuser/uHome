...
Flickable {
  ...
  Rectangle{
        ...
        anchors{
            bottom: headerTitle.bottom
            right: flickBackground.right
        ...
        Connections {
            ...
            python_main.call('main.removeFile', [backgroundlist.get(Math.round(flickBackground.contentX/units.gu(18))).src], function() {
            getListBackgrounds()
            });
            }
        }
        ...
        onPressed: {
            myDialog.text = i18n.tr("Are you sure to remove this Background?")
